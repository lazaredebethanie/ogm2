...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 01 mai 2018 à 14:45
...
INSERT INTO `contracts` (`id`, `name_contract`, `reference`, `supplier_id`, `purchase_type_id`, `purchase_family_id`, `maintenance_type_id`, `purchase_date`, `renewal_date`, `end_date`, `idPeriod`, `total_amount`, `business_unit_id`, `paid_by_id`, `comments`) VALUES
(4, 'ABAQUS', '', 2, 2, 1, 1, '2012-06-15', '2018-07-01', '2019-06-30', 0, '14568.65', 2, 3, 'Comm 1\r\ncomm 2\r\ncomm 3 ...\r\n'),
(5, 'test 02', 'ref02', 5, 1, 2, 1, '0000-00-00', '2015-05-16', '2016-05-15', 0, '0', 1, 3, ''),
(6, 'Contrat CES', '', 9, 1, 0, 2, '0000-00-00', '0000-00-00', '0000-00-00', 0, '55555', 1, 5, ''),
(7, 'Panorame eÂ²', '', 3, 1, 3, 1, '0000-00-00', '0000-00-00', '0000-00-00', 0, '0', 1, 3, ''),
(8, 'Idol', '', 10, 1, 0, 1, '0000-00-00', '2017-11-14', '0000-00-00', 0, '100000', 1, 3, ''),
(9, 'contrat', 'sans', 2, 2, 1, 1, '0000-00-00', '2018-01-02', '0000-00-00', 0, '0', 2, 3, ''),
(10, 'test 1', 'ref01', 5, 1, 2, 1, '2010-01-25', '2015-05-16', '2016-05-15', 0, '6852', 1, 3, 'un commentaire\r\nPuis un autre\r\net encore un\r\net un petit dernier\r\n'),
(12, 'deux', '', 8, 2, 3, 2, '0000-00-00', '2019-01-01', '0000-00-00', 0, '0', 1, 4, ''),
(13, 'avoir eb', '', 5, 1, 0, 1, '0000-00-00', '2019-01-01', '0000-00-00', 0, '-1000', 1, 3, ''),
(14, 'avoir 2', '', 9, 1, 0, 2, '0000-00-00', '2018-01-01', '0000-00-00', 0, '-5000', 1, 3, ''),
(15, 'il Ã©tait une fois un beau contrat de maintenance, qu\'il Ã©tait bÃ´ et pas cher.', 'ref01', 5, 1, 0, 1, '0000-00-00', '2018-01-01', '0000-00-00', 0, '77777', 1, 3, '');
...
--
-- Structure de la table `maintenance_line_period`
--

CREATE TABLE `maintenance_line_period` (
  `id` int(11) NOT NULL,
  `contrat_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `maintenance_line_period`
--

INSERT INTO `maintenance_line_period` (`id`, `contrat_id`, `date_debut_periode`, `date_fin_periode`, `montant_global`, `etat_workflow_id`, `date_init_workflow`, `commentaire_periode`, `offre_id`) VALUES
...
--
-- Structure de la table `periods_contracts`
--

CREATE TABLE `periods_contracts` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `periods_contracts`
--

INSERT INTO `periods_contracts` (`id`, `id_contract`, `renewal_date`, `end_date`) VALUES
(1, 4, '2012-06-15', '0000-00-00'),
(2, 10, '2017-07-01', NULL);
...
--
-- Index pour la table `maintenance_line_period`
--
ALTER TABLE `maintenance_line_period`
  ADD PRIMARY KEY (`id`);
...
--
-- Index pour la table `periods_contracts`
--
ALTER TABLE `periods_contracts`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `maintenance_line_period`
--
ALTER TABLE `maintenance_line_period`
...
--
-- AUTO_INCREMENT pour la table `periods_contracts`
--
ALTER TABLE `periods_contracts`
...
--
ALTER TABLE `fournisseurs`
  ADD CONSTRAINT `fournisseurs_ibfk_1` FOREIGN KEY (`groupe_id`) REFERENCES `groupes_fournisseurs` (`id`);
COMMIT;
